namespace InSelfLove.Services.Data.Tests
{
    ...
    public class ArticleServiceTests
    {
        ...
        public async Task GetBySlugReturnsCorrectArticle()
        {
            ...
            var slug = await this.articleService.Create(article);
            var dbArticle = await this.articleService.GetBySlug(slug, null);
        ...
        public async Task GetBySlugReturnsCorrectArticleAndComments()
        {
            ...
            for (int i = 0; i < articleComments.Length; i++)
            {
                ...
                Assert.Equal(TimezoneHelper.ToLocalTime(articleComments[i].CreatedOn, null), dbArticleComments[i].CreatedOn);
        ...
        public async Task GetBySlugReturnsNullWhenRequestingNonExistentArticle(string slug)
        {
            ...
            var nonExistentArticle = await this.articleService.GetBySlug(slug, null);
        ...
        public async Task EditThrowsArgumentExceptionWhenGivenInvalidArticle(string title, string imageUrl, string content)
        {
            ...
            var slug = await this.articleService.Create(article);
            var invalidArticle = await this.articleService.GetBySlug(slug, null);
        ...
        public async Task EditUpdatesEntityAndReturnsSlug()
        {
            ...
            var slug = await this.articleService.Create(article);
            var updatedArticle = await this.articleService.GetBySlug(slug, null);
            ...
            var dbUpdatedArticle = await this.articleService.GetBySlug(updatedArticle.Slug, null);
