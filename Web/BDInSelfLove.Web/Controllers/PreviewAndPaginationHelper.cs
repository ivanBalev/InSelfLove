namespace BDInSelfLove.Web.Controllers
{
    ...
    public class PreviewAndPaginationHelper : BaseController
    {
        ...
        public PreviewAndPaginationHelper(
        ...
        public PreviewAndPaginationHelper(IArticleService articleService)
        {
            this.articleService = articleService;
        }

        public PreviewAndPaginationHelper(IVideoService videoService)
        {
            this.videoService = videoService;
        }
